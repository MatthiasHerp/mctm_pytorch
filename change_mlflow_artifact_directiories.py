...
def change_artifact_directory_experiment(experiment_id):
...
if __name__ == "__main__":
    experiment = mlflow.get_experiment_by_name("epithel_hydra_mirror")
    change_artifact_directory_experiment(experiment.experiment_id)
