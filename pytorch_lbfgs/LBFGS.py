    ...
    def _gather_flat_grad(self):
        ...
        for p in self._params:
            if p.grad is None:
                ...
                view = p.grad.data.to_dense().contiguous().view(-1) #added  .contiguous()
                # Do to: https://github.com/cezannec/capsule_net_pytorch/issues/4
            else:
                view = p.grad.data.contiguous().view(-1) # added  .contiguous()
            views.append(view)
