...
#
    ...
    def forward(self, input, covariate=False, log_d = 0, inverse = False, return_log_d = False, new_input=True):
        ...
        if not inverse:
            ...
            output_first_derivativ, second_order_ridge_pen, first_order_ridge_pen, param_ridge_pen = self.transformation(input, derivativ=1)
    ...
    def transformation(self, input, derivativ=0, inverse=False, spline="bernstein"):
        # FunFact:
